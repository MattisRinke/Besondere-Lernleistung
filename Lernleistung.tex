...
\input{Unterdateien/01Projekt.tex}
\input{Unterdateien/02Entwicklungsweise.tex}

\section{Entwicklung}
\input{Unterdateien/03AppFunktionen}
\input{Unterdateien/04Server.tex}
\input{Unterdateien/05Datenbank.tex}
\input{Unterdateien/06Schultest.tex}
\input{Unterdateien/07Fazit.tex}
